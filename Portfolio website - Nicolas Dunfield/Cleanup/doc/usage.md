...
table of contents](Cleanup/doc/TOC.md)
...
get you started. [About the JavaScript](Cleanup/doc/js.md).
...
[Read more about the `.editorconfig` file](Cleanup/doc/misc.md#editorconfig).
...
refer to the [according documentation](Cleanup/doc/extend.md#apple-touch-icons).
